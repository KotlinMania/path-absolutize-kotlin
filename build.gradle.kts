...
kotlin {
    ...
    val xcf = XCFramework("PathAbsolutize")

    macosArm64 {
        binaries.framework { baseName = "PathAbsolutize"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "PathAbsolutize"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "PathAbsolutize"
        flattenPackage = "io.github.kotlinmania.pathabsolutize"
    }

    android {
        namespace = "io.github.kotlinmania.pathabsolutize"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "path-absolutize-kotlin", version.toString())

    pom {
        name.set("path-absolutize-kotlin")
        description.set("Kotlin Multiplatform port of magiclen/path-absolutize - A library for extending `Path` and `PathBuf` in order to get an absolute path and remove the containing dots")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/path-absolutize-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/path-absolutize-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/path-absolutize-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/path-absolutize-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assemblePathAbsolutizeXCFramework",
    "assemblePathAbsolutizeDebugXCFramework",
    "assemblePathAbsolutizeReleaseXCFramework",
    "assembleDebugIosFatFrameworkForPathAbsolutizeXCFramework",
    "assembleReleaseIosFatFrameworkForPathAbsolutizeXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForPathAbsolutizeXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForPathAbsolutizeXCFramework",
    "assembleDebugMacosFatFrameworkForPathAbsolutizeXCFramework",
    "assembleReleaseMacosFatFrameworkForPathAbsolutizeXCFramework",
    "assembleDebugTvosFatFrameworkForPathAbsolutizeXCFramework",
    "assembleReleaseTvosFatFrameworkForPathAbsolutizeXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForPathAbsolutizeXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForPathAbsolutizeXCFramework",
    "assembleDebugWatchosFatFrameworkForPathAbsolutizeXCFramework",
    "assembleReleaseWatchosFatFrameworkForPathAbsolutizeXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForPathAbsolutizeXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForPathAbsolutizeXCFramework",
