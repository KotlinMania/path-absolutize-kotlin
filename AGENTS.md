...
This file is the quick-reference operating contract for path-absolutize-kotlin. The longer
...
path-absolutize-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`path-absolutize`](https://crates.io/crates/path-absolutize). Upstream Rust is the behavioral oracle while the
